...
library(``papaja'')
r\_refs(``r-references.bib'')
analysisDF \textless- read.csv(``analysisDF.csv'')
df\_time \textless- read.csv(``Experiment\_2\_Dataset\_clean.csv'')
df\_time \textless- df\_time{[}-1:-2,{]}
library(lubridate)
average\_completion \textless- mean(as.numeric(df\_time\(Duration..in.seconds.)) stdv_DF <- sd(as.numeric(df_time\)Duration..in.seconds.))
